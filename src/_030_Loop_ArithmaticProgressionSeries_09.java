...
public class _030_Loop_ArithmaticProgressionSeries_09 
{
    public static void main(String[] args) 
    {
        Scanner sc = new Scanner(System.in);
        System.out.println("Lets create Arithmatic Progression series");
        System.out.print ("Enter starting Number in Series: ");
        int start = sc.nextInt();
        System.out.print ("Enter common difference in Series: ");
        int diff = sc.nextInt();
